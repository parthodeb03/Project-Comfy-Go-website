  ...
  <div id="tourist_body">
    <div id="tourist_sidebar">
      <nav id="tourist_nav">
        ...
        <a href="destinations.php" class="t_nav_link">Destinations</a>
    ...
    <div id="tourist_content">
      ...
      <section class="t_section" id="transport">
        ...
        <div id="route_filter">
          ...
          <a href="?route=Dhaka"       class="route_btn <?= $transport_route_filter === 'Dhaka'       ? 'active' : '' ?>">Dhaka</a>
          <a href="?route=Sylhet"      class="route_btn <?= $transport_route_filter === 'Sylhet'      ? 'active' : '' ?>">Sylhet</a>
          <a href="?route=Chittagong"  class="route_btn <?= $transport_route_filter === 'Chittagong'  ? 'active' : '' ?>">Chittagong</a>
        </div>
        ...
        <?php else: ?>
          <div class="t_table_wrap">
            <table class="t_table">
              <thead><tr><th>Type</th><th>Route</th><th>Fare (৳/person)</th><th>Book</th></tr></thead>
              <tbody>
      ...
      <section class="t_section" id="hotels">
        ...
        <div id="hotel_filter">
          ...
          <a href="?division=Dhaka#hotels"      class="route_btn <?= $division_filter === 'Dhaka'       ? 'active' : '' ?>">Dhaka</a>
          <a href="?division=Sylhet#hotels"     class="route_btn <?= $division_filter === 'Sylhet'      ? 'active' : '' ?>">Sylhet</a>
          <a href="?division=Chittagong#hotels" class="route_btn <?= $division_filter === 'Chittagong'  ? 'active' : '' ?>">Chittagong</a>
        </div>
        ...
        <?php else: ?>
          <div class="t_table_wrap">
            <table class="t_table">
              <thead><tr><th>Hotel Name</th><th>Division</th><th>District</th><th>Rating</th><th>Book</th></tr></thead>
              <tbody>
      ...
      <section class="t_section" id="guides">
        ...
        <div id="guide_filter">
          ...
          <a href="?guide_division=Dhaka#guides"      class="route_btn <?= $guide_div === 'Dhaka'       ? 'active' : '' ?>">Dhaka</a>
          <a href="?guide_division=Sylhet#guides"     class="route_btn <?= $guide_div === 'Sylhet'      ? 'active' : '' ?>">Sylhet</a>
          <a href="?guide_division=Chittagong#guides" class="route_btn <?= $guide_div === 'Chittagong'  ? 'active' : '' ?>">Chittagong</a>
        </div>
        ...
        <?php else: ?>
          <div class="t_table_wrap">
            <table class="t_table">
              <thead><tr><th>Name</th><th>Division</th><th>District</th><th>Contact</th><th>Book</th></tr></thead>
              <tbody>
      ...
      <section class="t_section" id="bookings">
        ...
        <?php else: ?>
          <div class="t_table_wrap">
            <table class="t_table">
              <thead><tr><th>Booking ID</th><th>Type</th><th>Date</th><th>Status</th><th>Price (৳)</th></tr></thead>
              <tbody>
